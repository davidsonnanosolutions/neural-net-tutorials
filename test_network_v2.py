## Test Network
import magpie_loader_2 as mgpl
import numpy as np
...
net = network2.Network([96, 30, 11], cost=network2.CrossEntropyCost)
...
test = (net.SGD(training_data, 100, 50, 0.3, evaluation_data=validation_data, monitor_evaluation_accuracy=True))
print test[1]
